...
public class WurflCapabilityServiceImplTest {
   ...
   public void testReloadAndCleanup() throws InterruptedException {
      ...
      final String wurflDirPath = "src/test/resources/wurfl";
      ...
      class ReloadThread extends Thread {
         ...
         public void run() {
            try {
               ...
               File wurflFile = new File("src/test/resources/wurfl/wurfl.xml");
               ...
               File wurflFilePatch = new File("src/test/resources/wurfl/wurfl_patch.xml");
